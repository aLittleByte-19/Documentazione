...
\begin{itemize}
    ...
    \item \textbf{Attività Pianificate (Sprint Backlog):} Una tabella di dettaglio che elenca i task assegnati ai vari ruoli, confrontando le ore preventivate con quelle effettivamente consumate a consuntivo. Ogni attività è accompagnata dal relativo stato di avanzamento, indicato con le diciture ``\textit{Completata}'' o ``\textit{In corso}''.
    \begin{quote}
