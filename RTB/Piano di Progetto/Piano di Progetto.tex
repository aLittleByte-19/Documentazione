...
\centering
    ...
    \begin{tabularx}{\textwidth}{|l|l|X|p{2cm}|p{2.5cm}|p{2.5cm}|}
        ...
        \hline 
        0.6.0 & 2026-05-12 & Aggiunto terzo sprint e iniziato il preventivo del quarto sprint & Eleonora Bellet & -\\
        \hline
...
\begin{table}[H]
    ...
    \hline
    Aggiornamento Analisi dei Requisiti & Analista & 5 & 6 & Completata \\
    \hline
...
\begin{itemize}
    ...
    \item \textbf{Problematiche Riscontrate:} La complessa integrazione delle tecnologie nel PoC ha richiesto uno sforzo superiore alle attese, generando uno scostamento di +7 ore totali concentrate esclusivamente nei ruoli tecnici (Progettista, Programmatore e Verificatore).
