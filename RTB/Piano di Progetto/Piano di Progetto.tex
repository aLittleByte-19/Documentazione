...
\noindent\textbf{Considerazioni (Sprint Review e Retrospective)}\\
Lo Sprint si è concluso con esito positivo, evidenziando criticità trascurabili e una distribuzione dei carichi di lavoro nel complesso equilibrata. Sotto il profilo economico, si è registrata una lieve sottostima delle ore preventivate rispetto ai dati effettivi di consuntivo. Il team si pone l'obiettivo di affinare le metriche di stima e ottimizzare la pianificazione già a partire dal prossimo sprint.
\newpage
...
\begin{table}[H]
    ...
    \hline \rowcolor{LimeGreen!50}
        \textbf{Descrizione Incarico} & \textbf{Ruolo Assegnato}\\
        \hline
        Aggiornamento Piano di Progetto & Responsabile\\
        Aggiornamento Glossario & Analista\\
        Aggiornamento Norme di Progetto & Amministratore\\
        Aggiornamento Analisi dei Requisiti & Analista\\
        Rifinitura Mock-up & Programmatore\\
        Studio delle tecnologie adottate & Progettista \\
        Redazione verbali interni e stesura verbale esterno con l'azienda & Responsabile\\
    \hline
    \end{tabularx}
\end{table}
...
\noindent\textbf{Considerazioni (Sprint Review e Retrospective)}\\
Analizzando il rendiconto orario dello Sprint, si evince un fisiologico scostamento rispetto al preventivo iniziale, derivato da una precisa scelta gestionale discussa internamente. Le ore inizialmente allocate per il ruolo di \textit{Progettista} sono state infatti ridotte per poter trasferire parte del budget orario sul ruolo di \textit{Analista}, al fine di sostenere l'intenso carico di lavoro richiesto in questa fase per la stesura dell'AdR. Inoltre, una piccola parte delle ore è stata investita nel ruolo di \textit{Programmatore} (non inizialmente preventivato) per consentire la realizzazione pratica e la rifinitura del mock-up. Questa rimodulazione dimostra la capacità del team di adattare in modo flessibile le risorse alle reali esigenze di progetto, ottimizzando il budget a disposizione senza comprometterne la stabilità.\\
\newpage
...
\begin{table}[H]
    ...
    \hline \rowcolor{LimeGreen!50}
        ...
        Aggiornamento Glossario & Analista\\
        Aggiornamento Norme di Progetto & Amministratore\\
        Conclusione Analisi dei Requisiti & Analista\\
        Definizione del PoC & Progettista\\
        Implementazione del PoC & Programmatore \\
        Redazione verbali interni e stesura verbale esterno con l'azienda & Responsabile\\
    \hline
    \end{tabularx}
\end{table}
...
\hline
\end{tabular}
\caption{Preventivo ore per componente}
\end{table}
...
\hiderowcolors
\rowcolor{green!50!black!20!white}
\textbf{Saldo fine periodo} &  \euro &  \euro &  \euro &  \euro &  \euro &  \euro & \cellcolor{yellow!50}  \euro  \\
\hline
\end{tabular}
