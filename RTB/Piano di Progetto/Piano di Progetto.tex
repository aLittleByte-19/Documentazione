...
\textbf{Problematiche Riscontrate:} Lieve rallentamento fisiologico per i ruoli di Analista e Progettista, dovuto alla curva di apprendimento nell'utilizzo dei tool grafici e alla fase di rodaggio nella stesura dei requisiti.\\
...
\paragraph{Considerazioni (Sprint Retrospective)}
\textbf{Problematiche Riscontrate:} Sottostima iniziale dell'intensità del lavoro richiesto per la diagrammazione dei requisiti ed emersione di attività tecniche non preventivate (ruolo del Programmatore) necessarie alla rifinitura del mock-up. 
\newpage
