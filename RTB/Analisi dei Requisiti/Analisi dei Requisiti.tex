...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[Pre-condizioni] La bozza revisionata (UC-2) è pronta per l'approvazione e presenta il marcatore di trasparenza "Creato da AI Assistant".
    
    \item[Post-condizioni] Il sistema ha promosso la bozza a documento e lo ha archiviato, esportato o inoltrato con successo.
...
\paragraph{UC-3.3: Esportazione del documento}
\mbox{} \\
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    \item[Attore Principale] Redattore
    \item[Pre-condizioni] Il sistema mostra i comandi di finalizzazione.
    \item[Post-condizioni] Il sistema ha generato un file scaricabile del documento, comprensivo del marcatore di trasparenza.
    \item[Scenario Principale] 
    \begin{enumerate}[leftmargin=*, nosep]
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[Post-condizioni] Il documento è stato trasmesso con successo all'indirizzo specificato.
    \item[Scenario Principale] 
    \begin{enumerate}[leftmargin=*, nosep]
