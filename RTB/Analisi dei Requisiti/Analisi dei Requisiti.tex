...
\begin{description}[style=multiline, leftmargin=4.5cm, font=\bfseries]
    \item[Attore Principale] Redattore
    \item[Pre-condizioni] Il sistema espone le opzioni di configurazione dei parametri di generazione.
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]    
    ...
    \begin{enumerate}[leftmargin=*, nosep]
        ...
        \item Il Redattore richiede la rigenerazione totale del contenuto all'AI (\textbf{UC-2.7}).
        \item Il Redattore scarta il contenuto generato eliminando la bozza corrente (\textbf{UC-2.8}).
        \item Il Redattore annulla le modifiche manuali per ripristinare il testo originale (\textbf{UC-2.9}).
    \end{enumerate}
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[Scenari Alternativi] 
    \begin{itemize}[leftmargin=*, nosep]
        \item \textbf{3a. Titolo vuoto}: Il sistema rileva che il campo del titolo è stato completamente svuotato; viene eseguito \textbf{UC-2.4.E1}.
    \end{itemize}
    \item[Relazioni] 
    \begin{itemize}[leftmargin=*, nosep]
        \item \textbf{Estensioni}: UC-2.4.E1.
    \end{itemize}
\end{description}
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[Scenari Alternativi] 
    \begin{itemize}[leftmargin=*, nosep]
        \item \textbf{2a. Testo vuoto}: Il sistema rileva che il campo del testo è stato completamente svuotato; viene eseguito \textbf{UC-2.4.E1}.
    \end{itemize}
...
\begin{description}[style=multiline, leftmargin=4.5cm, font=\bfseries]
    \item[Attore Principale] Redattore
    \item[Pre-condizioni] Il Redattore ha apportato modifiche testuali alla bozza (UC-2.4 o UC-2.5).
    \item[Post-condizioni] Il sistema ha ripristinato il testo alla versione originariamente generata dall'AI.
    \item[Scenario Principale] 
    \begin{enumerate}[leftmargin=*, nosep]
        \item Il Redattore seleziona il comando "Annulla modifiche".
        \item Il sistema sovrascrive le modifiche umane e ricarica a schermo il testo di partenza elaborato dal modulo AI.
    \end{enumerate}
\end{description}

\paragraph{UC-2.4.E1: Errore - Contenuto vuoto}
\mbox{} \\
...
\begin{description}[style=multiline, leftmargin=4.5cm, font=\bfseries]
    \item[Attore Principale] Redattore
    \item[Pre-condizioni] Il sistema mostra i comandi di finalizzazione e il Redattore intende esportare il file.
    \item[Post-condizioni] Il Redattore ha visualizzato a schermo l'aspetto del documento finale.
    \item[Scenario Principale] 
    \begin{enumerate}[leftmargin=*, nosep]
        \item Il Redattore seleziona il comando di anteprima di stampa/esportazione.
        \item Il sistema genera e mostra a schermo una preview del documento impaginato, rendendo visibile il marcatore di trasparenza ("Creato da AI Assistant").
    \end{enumerate}
\end{description}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{diagrammi_use_case/uc_15.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\textwidth]{diagrammi_use_case/uc_16.png}
