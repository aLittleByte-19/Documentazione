...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[Scenari Alternativi]
     \begin{itemize}[leftmargin=*, nosep]
         \item \textbf{1a. Il Redattore decide di svuotare i campi prima di iniziare}: viene eseguito \textbf{UC-1.5}.
         \item \textbf{5a. Il Redattore decide di salvare la configurazione inserita}: viene eseguito \textbf{UC-1.4}.
