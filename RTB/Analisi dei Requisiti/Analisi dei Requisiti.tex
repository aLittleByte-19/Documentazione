...
Il presente documento di Analisi dei Requisiti ha l'obiettivo di descrivere in modo completo e strutturato i requisiti funzionali e non funzionali del sistema software progettato per il \glslink{committente-o-proponente}{proponente} Eggon S.r.l. .\\
L'applicazione implementerà i moduli "\glslink{ai-intelligenza-artificiale}{AI} Assistant Generativo" e "\glslink{ai-co-pilot}{AI Co-Pilot} per i Consulenti del Lavoro", permettendo di sperimentare le funzionalità previste in un ambiente controllato.\\
...
I requisiti identificati costituiscono il riferimento per le attività di progettazione, sviluppo e collaudo dell'applicazione, garantendo coerenza con le esigenze del \glslink{committente-o-proponente}{committente} e con gli obiettivi formativi e tecnici del progetto. \\
...
Il presente documento è stato redatto adottando un approccio \glslink{incrementale}{incrementale}, con l’obiettivo di consentire aggiornamenti e revisioni nel corso del progetto.\\
La struttura e i contenuti sono stati definiti in modo da garantire flessibilità, permettendo di recepire eventuali modifiche derivanti dall’evoluzione dei requisiti o dal confronto con il \glslink{committente-o-proponente}{committente}.\\
...
L'obiettivo del progetto è potenziare i processi HR e documentali dei consulenti del lavoro con strumenti intelligenti mantenendo la soluzione autonoma rispetto \glslink{ai-intelligenza-artificiale}{ai} canali \glslink{nexum}{NEXUM} esistenti. In particolare il prodotto mira a:
\begin{itemize}
    ...
    \item ridurre tempi di gestione ed errori nella classificazione, suddivisione e distribuzione dei documenti massivi destinati \glslink{ai-intelligenza-artificiale}{ai} dipendenti;
    \item fornire \glslink{workflow}{workflow} tracciabili e conformi alle normative vigenti (sicurezza, \glslink{gdpr}{GDPR});
    \item abilitare un'evoluzione \glslink{data-driven}{data-driven} dei moduli \glslink{ai-intelligenza-artificiale}{AI} attraverso metriche di utilizzo, qualità e performance;
...
\begin{itemize}
    ...
    \item Riconoscimento tipologico tramite \glslink{ocr-riconoscimento-ottico-dei-caratteri}{OCR} e classificazione \glslink{ai-intelligenza-artificiale}{AI} con popolamento automatico dei \glslink{metadati}{metadati} principali.
    ...
    \item Composizione assistita della \glslink{lista-di-dispaccio}{lista di dispaccio} e dei messaggi di invio, compresi template riutilizzabili.
...
\begin{itemize}
    ...
    \item Raccolta centralizzata di metriche operative a supporto della governance e del miglioramento continuo dei modelli \glslink{ai-intelligenza-artificiale}{AI}.
...
\begin{itemize}
    ...
    \item \textbf{\glslink{audit-trail}{Audit trail}}: registro navigabile delle operazioni effettuate sul sistema, a supporto di attività di controllo e conformità normativa.
...
\begin{itemize}
    \item \textbf{Amministratori e \glslink{hr-manager}{HR Manager} aziendali}: utilizzano l'\glslink{ai-intelligenza-artificiale}{AI} Assistant Generativo per creare, revisionare e pubblicare comunicazioni interne coerenti con le linee guida editoriali.
    \item \textbf{Operatori e referenti degli studi dei Consulenti del Lavoro}: presidiano l'\glslink{ai-co-pilot}{AI Co-Pilot} per caricare, riconoscere, suddividere e distribuire documenti \glslink{ai-intelligenza-artificiale}{ai} destinatari corretti.
    \item \textbf{Figure di controllo e governance}: monitorano metriche e qualità dei moduli \glslink{ai-intelligenza-artificiale}{AI} per garantire conformità e miglioramento continuo.
\end{itemize}
...
\begin{itemize}
    \item \textbf{\glslink{amministratore}{Amministratore}}:Ha il compito di configurare l'ambiente \glslink{standalone}{standalone}. Si occupa di assegnare i privilegi operativi \glslink{ai-intelligenza-artificiale}{ai} vari account e di definire le policy globali dell'applicativo.
    \item \textbf{\glslink{redattore}{Redattore}}:È la figura aziendale delegata alla creazione delle comunicazioni interne. Interagisce in modo diretto con il Modulo \glslink{ai-intelligenza-artificiale}{AI} Assistant Generativo per fornire i \glslink{prompt}{prompt} di base, calibrare il tono di voce desiderato e confermare la bontà dei contenuti proposti dal sistema.
    \item \textbf{\glslink{analista-dati}{Analista dati}}: Supervisiona l'efficienza dell'applicativo. Accede alle sezioni analitiche per valutare le performance dell'\glslink{ai-intelligenza-artificiale}{intelligenza artificiale}, esaminando i feedback forniti dagli operatori e le metriche di successo del riconoscimento documentale.
    \item \textbf{\glslink{consulente-del-lavoro-cdl}{Consulente del lavoro}}:È l'utilizzatore primario del Modulo \glslink{ai-co-pilot}{AI Co-Pilot}. Il suo ruolo consiste nel caricare i lotti documentali (come i \glslink{cedolini-massivi}{cedolini massivi}), revisionare le estrazioni per correggere eventuali imperfezioni e validare le code di invio.
\end{itemize}
\subsubsection{Moduli esterni}
\begin{itemize}
    \item \textbf{\glslink{ai-post-generator}{AI Post Generator}}:Il core di \glslink{ai-intelligenza-artificiale}{intelligenza artificiale} che elabora le richieste del \glslink{redattore}{redattore}. Agisce come \glslink{attore}{attore} di sistema restituendo i testi formattati, i titoli e le immagini per le comunicazioni aziendali.
    \item \textbf{\glslink{ai-analyst}{AI Analyst}}:Costituisce il nucleo elaborativo del modulo \glslink{ai-co-pilot}{AI Co-Pilot}. Prende in carico i lotti di file caricati dall'operatore ed esegue in autonomia le operazioni di classificazione documentale, estrazione del testo e associazione \glslink{ai-intelligenza-artificiale}{ai} rispettivi destinatari.
\end{itemize}
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[\glslink{trigger}{Trigger}] Il \glslink{redattore}{Redattore} seleziona la funzione di creazione di un nuovo contenuto supportato dall'\glslink{ai-intelligenza-artificiale}{AI}.
    
    \item[Pre-condizioni]Il sistema ha inizializzato e reso operativo il modulo "\glslink{ai-intelligenza-artificiale}{AI} Assistant Generativo", preimpostando i parametri di tono, stile e lunghezza sui valori di default.
    ...
    \begin{enumerate}[leftmargin=*, nosep]
        \item Il \glslink{redattore}{Redattore} accede all'interfaccia dell'\glslink{ai-intelligenza-artificiale}{AI} Assistant Generativo, dove il sistema rende visibile l'area di lavoro.
    ...
    \item[Scenari Alternativi]
     \begin{itemize}[leftmargin=*, nosep]
         ...
         \item \textbf{6b. Fallimento modulo \glslink{ai-intelligenza-artificiale}{AI}}: Il sistema rileva un errore di \glslink{timeout}{timeout} o di rete dal motore di generazione; viene eseguito \textbf{UC-1.E2}.
    \end{itemize}
...
\begin{description}[style=multiline, leftmargin=4.5cm, font=\bfseries]
    ...
    \item[Post-condizioni] Il sistema ha ripristinato tutti i campi \glslink{ai-intelligenza-artificiale}{ai} valori predefiniti o vuoti.
    \item[\glslink{scenario-principale}{Scenario Principale}] 
    \begin{enumerate}[leftmargin=*, nosep]
        \item Il \glslink{redattore}{Redattore} seleziona il comando rapido di azzeramento (es. "Svuota campi").
        \item Il sistema cancella il testo inserito nel \glslink{prompt}{prompt} e ripristina le selezioni di tono e stile \glslink{ai-intelligenza-artificiale}{ai} valori di default.
    \end{enumerate}
\end{description}
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[Pre-condizioni] Il sistema ha inviato i parametri al motore \glslink{ai-intelligenza-artificiale}{AI}, ma si verifica un \glslink{timeout}{timeout} o un errore di connessione.
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]    
    ...
    \begin{enumerate}[leftmargin=*, nosep]
        ...
        \item Il \glslink{redattore}{Redattore} richiede la rigenerazione totale della \glslink{bozza-draft}{bozza} all'\glslink{ai-intelligenza-artificiale}{AI} (\textbf{UC-2.7}).
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[Scenari Alternativi] 
    \begin{itemize}[leftmargin=*, nosep]
        \item \textbf{1a. Fallimento modulo \glslink{ai-intelligenza-artificiale}{AI}}: Il sistema rileva un errore di rete o di API durante la richiesta della variante; viene eseguito \textbf{UC-2.7.E1}.
    \end{itemize}
...
\begin{description}[style=multiline, leftmargin=4.5cm, font=\bfseries]
    ...
    \item[Post-condizioni] Il sistema ha ripristinato la \glslink{bozza-draft}{bozza} alla versione originariamente generata dall'\glslink{ai-intelligenza-artificiale}{AI}.
    \item[\glslink{scenario-principale}{Scenario Principale}] 
    \begin{enumerate}[leftmargin=*, nosep]
        \item Il \glslink{redattore}{Redattore} seleziona il comando "Annulla modifiche".
        \item Il sistema sovrascrive le modifiche manuali e ricarica a schermo la \glslink{bozza-draft}{bozza} originale elaborata dal modulo \glslink{ai-intelligenza-artificiale}{AI}.
    \end{enumerate}
\end{description}
...
\begin{description}[style=multiline, leftmargin=4.5cm, font=\bfseries]
    \item[\glslink{attore}{Attore} Principale] \glslink{redattore}{Redattore}
    \item[Pre-condizioni] Il sistema mostra i comandi di finalizzazione.
    \item[Post-condizioni] Il sistema ha generato un file PDF scaricabile comprensivo del \glslink{marcatore-di-trasparenza}{marcatore di trasparenza} ``Creato da \glslink{ai-intelligenza-artificiale}{AI} Assistant''.
    \item[\glslink{scenario-principale}{Scenario Principale}] 
    \begin{enumerate}[leftmargin=*, nosep]
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[Post-condizioni] Il documento è stato trasmesso con successo all'indirizzo specificato, con il \glslink{marcatore-di-trasparenza}{marcatore di trasparenza} ``Creato da \glslink{ai-intelligenza-artificiale}{AI} Assistant''.
    \item[\glslink{scenario-principale}{Scenario Principale}] 
    \begin{enumerate}[leftmargin=*, nosep]
...
\begin{description}[style=multiline, leftmargin=4.5cm, font=\bfseries]
    ...
    \item[Post-condizioni] Il \glslink{redattore}{Redattore} ha visualizzato a schermo l'aspetto del documento finale, comprensivo del \glslink{marcatore-di-trasparenza}{marcatore di trasparenza} ``Creato da \glslink{ai-intelligenza-artificiale}{AI} Assistant''.
    \item[\glslink{scenario-principale}{Scenario Principale}] 
    \begin{enumerate}[leftmargin=*, nosep]
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[Post-condizioni] Il sistema aggiorna la lista in base \glslink{ai-intelligenza-artificiale}{ai} criteri inseriti.
    \item[\glslink{scenario-principale}{Scenario Principale}] 
    \begin{enumerate}[leftmargin=*, nosep]
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[\glslink{trigger}{Trigger}] L'\glslink{analista-dati}{Analista dati} accede all'area analitica per monitorare le performance e l'utilizzo dell'\glslink{ai-intelligenza-artificiale}{AI} Assistant.

    \item[Pre-condizioni] Il sistema ha archiviato i dati di utilizzo dell'Assistente \glslink{ai-intelligenza-artificiale}{AI} e le valutazioni qualitative degli utenti.
    ...
    \begin{enumerate}[leftmargin=*, nosep]
        ...
        \item L'\glslink{analista-dati}{Analista dati} applica filtri dinamici \glslink{ai-intelligenza-artificiale}{ai} dati visualizzati (\textbf{UC-6.5}).
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[\glslink{scenario-principale}{Scenario Principale}] 
    \begin{enumerate}[leftmargin=*, nosep]
        \item Il sistema presenta a schermo l'interfaccia di monitoraggio con i principali indicatori di performance dell'\glslink{ai-intelligenza-artificiale}{AI} Assistant.
    \end{enumerate}
\end{description}
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[\glslink{scenario-principale}{Scenario Principale}] 
    \begin{enumerate}[leftmargin=*, nosep]
        \item Il sistema visualizza il valore medio delle valutazioni a stelle ricevute per misurare l'efficacia dell'\glslink{ai-intelligenza-artificiale}{AI}.
    \end{enumerate}
\end{description}
...
\begin{description}[style=multiline, leftmargin=4.5cm, font=\bfseries]
    ...
    \item[Post-condizioni] Il sistema aggiorna la visualizzazione in base \glslink{ai-intelligenza-artificiale}{ai} parametri selezionati.
    \item[\glslink{scenario-principale}{Scenario Principale}] 
    \begin{enumerate}[leftmargin=*, nosep]
        \item L'\glslink{analista-dati}{Analista dati} imposta parametri specifici di filtro (es. intervallo di date, tono, stile).
        \item Il sistema aggiorna istantaneamente la visualizzazione in base \glslink{ai-intelligenza-artificiale}{ai} criteri scelti.
    \end{enumerate}
    \item[Scenari Alternativi] 
    \begin{itemize}[leftmargin=*, nosep]
        \item \textbf{2a. Dati non disponibili}: Il sistema rileva l'assenza di record corrispondenti \glslink{ai-intelligenza-artificiale}{ai} filtri applicati; viene eseguito \textbf{UC-6.E1}.
    \end{itemize}
    \item[Relazioni] 
    \begin{itemize}[leftmargin=*, nosep]
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[Pre-condizioni] Il \glslink{consulente-del-lavoro-cdl}{Consulente del lavoro} si trova nella sezione di upload del modulo \glslink{ai-co-pilot}{AI Co-Pilot}.
    
    \item[Post-condizioni]Il documento è caricato e analizzato dall'\glslink{ai-intelligenza-artificiale}{AI} (estrazione \glslink{metadati}{metadati}, classificazione e split in sotto-documenti per destinatario).
    ...
    \begin{enumerate}[leftmargin=*, nosep]
        ...
        \item Il sistema completa il caricamento, notifica l'esito positivo e avvia l'analisi \glslink{ai-intelligenza-artificiale}{AI} del documento.
    \end{enumerate}
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[Pre-condizioni] Il \glslink{consulente-del-lavoro-cdl}{Consulente del lavoro} si trova nella sezione di upload del modulo \glslink{ai-co-pilot}{AI Co-Pilot}.   
    \item[Post-condizioni] Il documento è caricato e analizzato dall'\glslink{ai-intelligenza-artificiale}{AI}; classificazione e \glslink{metadati}{metadati} inseriti manualmente non vengono ricalcolati mentre viene già eseguito lo split (del documento in sotto-documenti per destinatario).
    ...
    \begin{enumerate}[leftmargin=*, nosep]
        ...
        \item Il sistema completa il caricamento, avvia l'analisi \glslink{ai-intelligenza-artificiale}{AI} del documento e mantiene i campi inseriti dall'utente.
    \end{enumerate}
    \item[Scenari Alternativi]
    \begin{itemize}[leftmargin=*, nosep]
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    \item[\glslink{attore}{Attore} Principale] \glslink{consulente-del-lavoro-cdl}{Consulente del lavoro}
    \item[\glslink{trigger}{Trigger}] Il \glslink{consulente-del-lavoro-cdl}{Consulente del lavoro} intende consultare lo storico dei documenti analizzati nel modulo \glslink{ai-co-pilot}{AI Co-Pilot}.
    \item[Pre-condizioni] Il \glslink{consulente-del-lavoro-cdl}{Consulente del lavoro} si trova nel modulo \glslink{ai-co-pilot}{AI Co-Pilot} e apre la sezione "Storico documenti".
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \begin{enumerate}[leftmargin=*, nosep]
        ...
        \item Il sistema apre la vista di dettaglio con \glslink{layout-affiancato}{layout affiancato}: documento originale a sinistra e dati estratti a destra.
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[\glslink{scenario-principale}{Scenario Principale}]
    \begin{enumerate}[leftmargin=*, nosep]
        \item Il sistema visualizza nel pannello dati estratti la \glslink{confidenza-confidence-score}{confidenza} in percentuale (da 0 a 100\%) che indica l'affidabilità dei dati estratti dall'\glslink{ai-intelligenza-artificiale}{AI} per il documento analizzato.
    \end{enumerate}
    \item[Scenari Alternativi]
    \begin{itemize}[leftmargin=*, nosep]
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[Post-condizioni] Il sistema salva le modifiche apportate \glslink{ai-intelligenza-artificiale}{ai} campi editabili del documento selezionato.
    \item[\glslink{scenario-principale}{Scenario Principale}]
    \begin{enumerate}[leftmargin=*, nosep]
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    \item[\glslink{attore}{Attore} Principale] \glslink{consulente-del-lavoro-cdl}{Consulente del lavoro}
    \item[Pre-condizioni] Il sistema ha accesso \glslink{ai-intelligenza-artificiale}{ai} \glslink{metadati}{metadati} principali del documento selezionato.
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    \item[\glslink{attore}{Attore} Principale] \glslink{consulente-del-lavoro-cdl}{Consulente del lavoro}
    \item[Pre-condizioni] Il sistema ha accesso \glslink{ai-intelligenza-artificiale}{ai} dati estratti dal documento selezionato.
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    \item[\glslink{attore}{Attore} Principale] \glslink{analista-dati}{Analista dati}
    \item[\glslink{trigger}{Trigger}] L'\glslink{analista-dati}{Analista dati} intende consultare la \glslink{dashboard}{dashboard} delle metriche del modulo \glslink{ai-co-pilot}{AI Co-Pilot}.
    \item[Pre-condizioni] L'\glslink{analista-dati}{Analista dati} è entrato nella sezione dedicata alle metriche del modulo \glslink{ai-co-pilot}{AI Co-Pilot}.
    \item[Post-condizioni] L'\glslink{analista-dati}{Analista dati} ha visualizzato in \glslink{dashboard}{dashboard} i principali \glslink{kpi-key-performance-indicator}{KPI} del modulo \glslink{ai-co-pilot}{AI Co-Pilot}.
    \item[\glslink{scenario-principale}{Scenario Principale}]
    \begin{enumerate}[leftmargin=*, nosep]
        ...
        \item Il sistema espone i tempi medi di analisi dell'\glslink{ai-intelligenza-artificiale}{intelligenza artificiale}; l'\glslink{analista-dati}{Analista dati} controlla il dato (\textbf{UC-19.5}).
    \end{enumerate}
    \item[Relazioni]
    \begin{itemize}[leftmargin=*, nosep]
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[Post-condizioni] L'\glslink{analista-dati}{Analista dati} visualizza il numero totale dei documenti analizzati dal modulo \glslink{ai-co-pilot}{AI Co-Pilot}.
    \item[\glslink{scenario-principale}{Scenario Principale}]
    \begin{enumerate}[leftmargin=*, nosep]
        \item Il sistema visualizza il numero totale complessivo di tutti i documenti processati dall'\glslink{ai-intelligenza-artificiale}{intelligenza artificiale}.
        \item L'\glslink{analista-dati}{Analista dati} osserva l'indicatore relativo \glslink{ai-intelligenza-artificiale}{ai} volumi di utilizzo.
    \end{enumerate}
\end{description}
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    \item[\glslink{attore}{Attore} Principale] \glslink{analista-dati}{Analista dati}
    \item[Pre-condizioni] L'\glslink{analista-dati}{Analista dati} si trova all'interno della \glslink{dashboard}{dashboard} delle metriche.
    \item[Post-condizioni] L'\glslink{analista-dati}{Analista dati} visualizza la percentuale di classificazioni corrette effettuate automaticamente dall'\glslink{ai-intelligenza-artificiale}{AI}.
    \item[\glslink{scenario-principale}{Scenario Principale}]
    \begin{enumerate}[leftmargin=*, nosep]
        \item Il sistema visualizza la percentuale complessiva di documenti classificati correttamente dall'\glslink{ai-intelligenza-artificiale}{AI} sul totale analizzato, calcolata considerando solo i casi che non hanno richiesto alcun intervento manuale da parte degli operatori.
        \item L'\glslink{analista-dati}{Analista dati} osserva la metrica relativa all'\glslink{accuratezza}{accuratezza} del sistema.
    \end{enumerate}
\end{description}
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    ...
    \item[\glslink{scenario-principale}{Scenario Principale}]
    \begin{enumerate}[leftmargin=*, nosep]
        \item Il sistema visualizza il numero totale e la relativa percentuale dei documenti per i quali l'\glslink{ai-intelligenza-artificiale}{AI} ha stimato una \glslink{confidenza-confidence-score}{confidenza} inferiore all'80\%, e che per questo motivo hanno richiesto una revisione umana.
        \item L'\glslink{analista-dati}{Analista dati} osserva le percentuali relative all'\glslink{accuratezza}{accuratezza} del sistema.
    \end{enumerate}
\end{description}
\newpage
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    \item[\glslink{attore}{Attore} Principale] \glslink{analista-dati}{Analista dati}
    \item[Pre-condizioni] L'\glslink{analista-dati}{Analista dati} si trova all'interno della \glslink{dashboard}{dashboard} delle metriche.
    \item[Post-condizioni] L'\glslink{analista-dati}{Analista dati} visualizza la percentuale di associazioni destinatario-anagrafica risolte automaticamente e correttamente dall'\glslink{ai-intelligenza-artificiale}{AI}.
    \item[\glslink{scenario-principale}{Scenario Principale}]
    \begin{enumerate}[leftmargin=*, nosep]
        \item Il sistema visualizza la percentuale complessiva di documenti in cui l'associazione tra il destinatario e la sua anagrafica è stata risolta in modo automatico e corretto dall'\glslink{ai-intelligenza-artificiale}{AI}.
...
\begin{description}[style=multiline, leftmargin=4cm, font=\bfseries]
    \item[\glslink{attore}{Attore} Principale] \glslink{analista-dati}{Analista dati}
    \item[Pre-condizioni] L'\glslink{analista-dati}{Analista dati} si trova all'interno della \glslink{dashboard}{dashboard} delle metriche.
    \item[Post-condizioni] L'\glslink{analista-dati}{Analista dati} visualizza il tempo medio necessario all'\glslink{ai-intelligenza-artificiale}{AI} per completare l'analisi di un documento.
    \item[\glslink{scenario-principale}{Scenario Principale}]
    \begin{enumerate}[leftmargin=*, nosep]
        \item Il sistema visualizza il tempo medio impiegato dall'\glslink{ai-intelligenza-artificiale}{AI} per elaborare interamente un documento caricato e restituirne l'analisi completa all'utente.
...
\begin{itemize}
    ...
    \item \textbf{Requisiti di qualità} (\glslink{redis-queue-rq}{RQ}): definiscono gli standard di processo e di prodotto che il gruppo deve rispettare;
...
\begin{longtable}{|p{2.5cm}|p{9.5cm}|p{3.5cm}|}
    ...
    \multicolumn{3}{|l|}{\cellcolor{gray!12}\textbf{\glslink{ai-intelligenza-artificiale}{AI} Assistant Generativo}} \\
    \hline
    ...
    \hline
    RF9-OB & Il sistema deve notificare il \glslink{redattore}{Redattore} in caso di errore interno o \glslink{timeout}{timeout} durante la generazione iniziale del contenuto tramite \glslink{ai-intelligenza-artificiale}{AI}. & \hyperref[fig:uc-1.e2]{UC-1.E2} \\
    \hline
    RF10-OB & Il sistema deve notificare il \glslink{redattore}{Redattore} in caso di errore interno o \glslink{timeout}{timeout} durante la rigenerazione del contenuto tramite \glslink{ai-intelligenza-artificiale}{AI}. & \hyperref[fig:uc-2.7.e1]{UC-2.7.E1} \\
    \hline
    ...
    \hline
    RF44-OB & Il sistema deve fornire all'\glslink{analista-dati}{Analista dati} una \glslink{dashboard}{dashboard} dedicata con metriche di utilizzo del modulo \glslink{ai-intelligenza-artificiale}{AI} Assistant Generativo. & \hyperref[fig:uc-6]{UC-6} \\
    \hline
    RF45-OB & Il sistema deve visualizzare nella \glslink{dashboard}{dashboard} una panoramica dell'attività complessiva del modulo \glslink{ai-intelligenza-artificiale}{AI} Assistant. & \hyperref[fig:uc-6.1]{UC-6.1} \\
    \hline
    RF46-OB & Il sistema deve visualizzare nella \glslink{dashboard}{dashboard} le statistiche di utilizzo del modulo \glslink{ai-intelligenza-artificiale}{AI} Assistant. & \hyperref[fig:uc-6.2]{UC-6.2} \\
    \hline
    ...
    \hline
    RF49-OB & Il sistema deve permettere all'\glslink{analista-dati}{Analista dati} di applicare filtri dinamici \glslink{ai-intelligenza-artificiale}{ai} dati visualizzati nella \glslink{dashboard}{dashboard} analitica (es. intervallo di date, tono, stile). & \hyperref[fig:uc-6.5]{UC-6.5} \\
    \hline
    ...
    \multicolumn{3}{|l|}{\cellcolor{gray!12}\textbf{\glslink{ai-co-pilot}{AI Co-Pilot} per Consulenti del Lavoro}} \\
    \hline
    RF52-OB & Il sistema deve permettere al \glslink{consulente-del-lavoro-cdl}{Consulente del lavoro} di caricare singoli documenti o lotti nel repository dedicato. & \hyperref[fig:uc-7]{UC-7} \\
    \hline
    ...
    \hline
    RF57-OB & Il sistema deve notificare l'utente quando nessun documento corrisponde \glslink{ai-intelligenza-artificiale}{ai} criteri di visualizzazione dello storico. & \hyperref[fig:uc-9.e1]{UC-9.E1} \\
    \hline
    ...
    \hline
    RF61-OB & Il sistema deve permettere il filtraggio dello storico documenti per livello di \glslink{confidenza-confidence-score}{confidenza} dell'analisi \glslink{ai-intelligenza-artificiale}{AI}. & \hyperref[fig:uc-13]{UC-13} \\
    \hline
    ...
    \hline
    RF105-OB & Il sistema deve fornire all'\glslink{analista-dati}{Analista dati} una \glslink{dashboard}{dashboard} dedicata con metriche di monitoraggio del modulo \glslink{ai-co-pilot}{AI Co-Pilot}. & \hyperref[fig:uc-19]{UC-19} \\
    \hline
...
\renewcommand{\arraystretch}{1.3}
\begin{longtable}{|p{2.5cm}|p{9.5cm}|p{3.5cm}|}
    \caption{Requisiti di qualità} \label{tab:redis-queue-rq} \\
    \hline
    \rowcolor{gray!20}
    \textbf{Codice} & \textbf{Descrizione} & \textbf{Fonte} \\
    \hline
    ...
    \hline
    RQ7-OB & Il modulo \glslink{ai-co-pilot}{AI Co-Pilot} deve raggiungere una \glslink{confidenza-confidence-score}{confidenza} media \glslink{ocr-riconoscimento-ottico-dei-caratteri}{OCR} $\geq$ 90\% e un'\glslink{accuratezza}{accuratezza} di mapping del codice fiscale $\geq$ 99\%; i documenti con \glslink{confidenza-confidence-score}{confidenza} inferiore alla soglia devono essere indirizzati alla revisione \glslink{human-in-the-loop}{human-in-the-loop}. & \href{https://www.math.unipd.it/~tullio/IS-1/2025/Progetto/C5.pdf}{Capitolato} \\
    \hline
    RQ8-OB & La qualità percepita dei contenuti generati dal modulo \glslink{ai-intelligenza-artificiale}{AI} Assistant deve risultare $\geq$ 4/5 nel sistema di \glslink{rating}{rating} utenti integrato. & \href{https://www.math.unipd.it/~tullio/IS-1/2025/Progetto/C5.pdf}{Capitolato} \\
    \hline
    ...
    \hline
    RQ10-OB & Le operazioni computazionalmente onerose (classificazione \glslink{ai-intelligenza-artificiale}{AI}, generazione di contenuti, split documentale) devono essere eseguite in modo asincrono, senza bloccare l'interfaccia utente. & \href{https://www.math.unipd.it/~tullio/IS-1/2025/Progetto/C5.pdf}{Capitolato} \\
    \hline
...
I requisiti di vincolo definiscono i limiti tecnologici entro cui il sistema deve essere sviluppato, derivanti dalle scelte architetturali concordate con il \glslink{committente-o-proponente}{proponente} Eggon S.r.l.
...
\begin{longtable}{|p{2.5cm}|p{9.5cm}|p{3.5cm}|}
    ...
    \hline
    RVC1-OB & Il codice sorgente deve essere versionato tramite \glslink{git}{Git} su un repository condiviso. & \glslink{committente-o-proponente}{Proponente} \\
    \hline
    ...
    \hline
    RVC7-OB & Il frontend delle interfacce utente deve essere realizzato tramite il motore di template Blade con CSS e JavaScript vanilla. & Interna/\glslink{committente-o-proponente}{Proponente} \\
    \hline

    \multicolumn{3}{|l|}{\cellcolor{gray!12}\textbf{Infrastruttura}} \\
    \hline
    RVC8-OB & L'ambiente di sviluppo e di esecuzione del sistema deve essere containerizzato tramite Docker e orchestrato con Docker Compose. & Interna/\glslink{committente-o-proponente}{Proponente} \\
    \hline
    RVC9-OB & Il web server dell'applicazione deve essere Nginx. & Interna/\glslink{committente-o-proponente}{Proponente} \\
    \hline
    RVC10-OB & Lo storage dei file caricati nel sistema deve utilizzare \glslink{minio}{MinIO}, servizio compatibile con le API Amazon S3. & Interna/\glslink{committente-o-proponente}{Proponente} \\
    \hline

    \multicolumn{3}{|l|}{\cellcolor{gray!12}\textbf{Modelli \glslink{ai-intelligenza-artificiale}{AI}}} \\
    \hline
    RVC11-OP & I modelli di \glslink{ai-intelligenza-artificiale}{intelligenza artificiale} generativa possono essere erogati tramite \glslink{amazon-bedrock}{Amazon Bedrock}. & Interna/\glslink{committente-o-proponente}{Proponente} \\
    \hline

    \multicolumn{3}{|l|}{\cellcolor{gray!12}\textbf{Accessibilità}} \\
    \hline
    RVC12-OB & Il sistema deve superare i controlli di accessibilità automatizzati eseguiti tramite lo strumento pa11y e axe sulle interfacce utente principali tramite Playwright su Chromium. & Interna/\glslink{committente-o-proponente}{Proponente} \\
    \hline

    \multicolumn{3}{|l|}{\cellcolor{gray!12}\textbf{Browser supportati}} \\
    \hline
    RVC13-OB & Il sistema deve essere fruibile sui principali browser moderni evergreen nelle versioni esplicitamente verificate alla data di produzione del documento: Google Chrome (min.\ 147), Microsoft Edge (min.\ 147), Mozilla Firefox (min.\ 149) e Safari (min.\ 26.4). La compatibilità con versioni successive è un obiettivo progettuale, non una garanzia automatica. Non sono supportati Internet Explorer, Edge Legacy e browser embedded obsoleti. & Interna/\glslink{committente-o-proponente}{Proponente} \\
    \hline

    \multicolumn{3}{|l|}{\cellcolor{gray!12}\textbf{Requisiti minimi di sistema}} \\
    \hline
    RVC14-OB & L'ambiente di esecuzione deve essere containerizzato con Docker Compose. Lo stack comprende: Nginx, PHP-FPM 8.4, Laravel 12, \glslink{postgresql}{PostgreSQL} 16, Redis 7 e storage S3-compatible (\glslink{minio}{MinIO}). & Interna/\glslink{committente-o-proponente}{Proponente} \\
    \hline
    RVC15-OB & La configurazione minima del server richiede 2 vCPU, 4 GB di RAM e 10 GB di spazio disco, con porta HTTP esposta su 8080 o reverse proxy HTTPS. & Interna/\glslink{committente-o-proponente}{Proponente} \\
    \hline
    RVC16-OB & L'utilizzo delle funzionalità \glslink{ai-intelligenza-artificiale}{AI} richiede credenziali AWS valide e accesso outbound ad \glslink{amazon-bedrock}{Amazon Bedrock}. & Interna/\glslink{committente-o-proponente}{Proponente} \\
    \hline
...
\begin{longtable}{|p{3cm}|p{6cm}|}
    ...
    \multicolumn{2}{|l|}{\cellcolor{gray!12}\textbf{\glslink{ai-intelligenza-artificiale}{AI} Assistant Generativo}} \\
    \hline
    UC-1 & RF7-OB \\
    \hline
    UC-1.1 & RF1-OB \\
    ...
    \multicolumn{2}{|l|}{\cellcolor{gray!12}\textbf{\glslink{ai-co-pilot}{AI Co-Pilot} per Consulenti del Lavoro}} \\
    \hline
    UC-7 & RF52-OB \\
    \hline
    UC-7.E1 & RF53-OB \\
