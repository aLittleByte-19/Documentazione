...
\begin{longtable}{|p{2.5cm}|p{9.5cm}|p{3.5cm}|}
    ...
    \hline
    RF23-OB & Il sistema deve permettere al Redattore di approvare e finalizzare il documento generato. & \hyperref[fig:uc-3]{UC-3} \\
    \hline
    RF24-OB & Il sistema deve visualizzare le opzioni disponibili per la finalizzazione del documento (salvataggio in bozza, esportazione, inoltro). & \hyperref[fig:uc-3.1]{UC-3.1} \\
    \hline
    ...
    \hline
    RF30-OB & Il sistema deve fornire al Redattore una libreria personale dei prompt con il relativo storico delle generazioni passate. & \hyperref[fig:uc-4]{UC-4} \\
    \hline
    ...
    \hline
    RF32-OB & Il sistema deve permettere la ricerca e il filtraggio dello storico dei prompt e delle generazioni passate. & \hyperref[fig:uc-4.2]{UC-4.2} \\
    \hline
    ...
    \hline
    RF35-OB & Il sistema deve permettere al Redattore di contrassegnare o rimuovere una generazione come preferita nella libreria personale. & \hyperref[fig:uc-4.4]{UC-4.4} \\
    \hline
    ...
    \hline
    RF38-OB & Il sistema deve permettere al Redattore di accedere al modulo di valutazione qualitativa della bozza generata. & \hyperref[fig:uc-5.1]{UC-5.1} \\
    \hline
    RF39-OB & Il sistema deve permettere al Redattore di assegnare un rating numerico alla bozza generata. & \hyperref[fig:uc-5.2]{UC-5.2} \\
    \hline
    RF40-OB & Il sistema deve permettere al Redattore di inserire un commento testuale opzionale nell'ambito della valutazione della bozza. & \hyperref[fig:uc-5.3]{UC-5.3} \\
    \hline
    RF41-OB & Il sistema deve permettere al Redattore di inviare la valutazione al sistema. & \hyperref[fig:uc-5.4]{UC-5.4} \\
    \hline
    RF42-OB & Il sistema deve notificare il Redattore qualora tenti di inviare la valutazione senza aver assegnato un rating. & \hyperref[fig:uc-5.4.e1]{UC-5.4.E1} \\
    \hline
    RF43-OB & Il sistema deve notificare il Redattore qualora il commento testuale superi il limite di caratteri consentito. & \hyperref[fig:uc-5.3.e1]{UC-5.3.E1} \\
    \hline
    ...
    \hline
    RF45-OB & Il sistema deve visualizzare nella dashboard una panoramica dell'attività complessiva del modulo AI Assistant. & \hyperref[fig:uc-6.1]{UC-6.1} \\
    \hline
    ...
    \hline
    RF49-OB & Il sistema deve permettere all'Analista dati di applicare filtri dinamici ai dati visualizzati nella dashboard analitica (es. intervallo di date, tono, stile). & \hyperref[fig:uc-6.5]{UC-6.5} \\
    \hline
    ...
    \hline
    RF51-OB & Il sistema deve notificare l'Analista dati qualora i dati non siano disponibili per l'esportazione del report. & \hyperref[fig:uc-6.6.e1]{UC-6.6.E1} \\
    \hline
...
\begin{longtable}{|p{4cm}|p{3cm}|p{3cm}|p{3cm}|}
    ...
    Funzionali & 96 & 13 & 109 \\
    \hline
    Di qualità & 6 & 0 & 6 \\
    \hline
    Di vincolo & 15 & 1 & 16 \\
    \hline
    \rowcolor{gray!12}\textbf{Totale} & \textbf{117} & \textbf{14} & \textbf{131} \\
