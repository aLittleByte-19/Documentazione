...
\fancyfoot[L]{\includegraphics[height=0.6cm]{\groupsymbol}\hspace{0.45em}aLittleByte}
    \fancyfoot[C]{\thepage}
\fancyfoot[R]{Verbale 2026-03-30}
...
\begin{center}
    {\LARGE \textbf{Verbale Interno - 2026-03-30}}
\end{center}
...
\section{Ordine del Giorno}
    \begin{itemize}
    \item \glslink{pianificazione}{Pianificazione} contatto iniziale con l'azienda
    \item Assegnazione e organizzazione del lavoro sui documenti di progetto
    \item Scelta degli strumenti per la realizzazione del mock-up
    \end{itemize}
...
\glslink{analisi-dei-requisiti-adr}{analisi dei requisiti}, \glslink{norme-di-progetto}{norme di progetto}, \glslink{glossario}{glossario}, lista dei quesiti e mock-up. Vista la complessità e la lunghezza di alcuni documenti, 
si è convenuto che l'\glslink{analisi-dei-requisiti-adr}{analisi dei requisiti} sarà sviluppata da due persone (Angelica e Angela) per evitare perdita di tempo e facilitarne la stesura. 
Le \glslink{norme-di-progetto}{norme di progetto} saranno gestite da Diego ed Eleonora, mentre Yuri si occuperà del \glslink{glossario}{glossario}. 
È stato discusso che il \glslink{piano-di-progetto}{piano di progetto} e il \glslink{piano-di-qualifica}{piano di qualifica} saranno affrontati più avanti, considerati meno immediati. 
...
\begin{itemize}
    ...
    \item \glslink{piano-di-progetto}{Piano di Progetto}
\end{itemize}

\subsection{Scelta degli strumenti per la realizzazione dei mock-up}
Si è discusso l'uso di strumenti per la progettazione dei mock-up, con un confronto tra Canva e \glslink{figma}{Figma}. 
\glslink{figma}{Figma} è stato indicato come preferibile per la sua versatilità, disponibilità di librerie e possibilità di collaborazione, 
anche se nella versione gratuita con alcune limitazioni. 
È stato menzionato un'alternativa open source, \glslink{penpot}{Penpot}, che gestisce file SVG, permettendo la gestione delle modifiche tramite commit in \glslink{repository}{repository}. 
Si è concordato di utilizzare \textbf{\glslink{penpot}{Penpot}} come programma per il mock-up.
...
\begin{table}[h]
    ...
    \hline
         \textit {Angelica Gastaldello e Angela Maule} & Inizio stesura \glslink{analisi-dei-requisiti-adr}{Analisi dei Requisiti}& \href{https://github.com/aLittleByte-19/Documentazione/issues/51}{\#51}\\
    \hline
        \textit{Diego Belluz e Eleonora Bellet} &  Inizio stesura \glslink{norme-di-progetto}{Norme di Progetto}& \href{https://github.com/aLittleByte-19/Documentazione/issues/52}{\#52}\\
    \hline
        \textit{Vinicius Yuri Kaneda Fernandes} & Inizio stesura \glslink{glossario}{Glossario} & \href{https://github.com/aLittleByte-19/Documentazione/issues/53}{\#53}\\
    \hline
        \textit{Angelica Gastaldello} & Stesura \glslink{verbale-interno}{Verbale Interno} 30/03/2026 & \href{https://github.com/aLittleByte-19/Documentazione/issues/54}{\#54}\\
    \hline
