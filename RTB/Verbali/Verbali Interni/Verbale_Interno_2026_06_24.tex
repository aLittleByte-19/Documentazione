...
\section{Ordine del Giorno}
    \begin{itemize}
    \item Preparazione della candidatura RTB 
...
la nostra candidatura per la revisione RTB per il giorno Venerdi 26 Giugno. 
...
Abbiamo chiesto l'approvazione delle tecnologie, tramite Telegram, ossia il canale di messaggistica predefinito dall'azienda per questo progetto, che abbiamo sostituito nel PoC all'azienda committente, principalmente l'utilizzo di Angular, la quale ci ha dato esito positivo.
