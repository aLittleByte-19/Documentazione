...
Per definire e misurare la qualità intrinseca del software, lo standard di riferimento adottato è la serie di norme ISO/IEC 25010. Questo standard internazionale organizza la qualità in due diverse categorie:
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Portabilità;
    \end{itemize}
    \item \textbf{Qualità in Uso}, che valuta le seguenti caratteristiche dal punto di vista dell'utente finale:
    \begin{itemize}
        \item Efficacia;
        \item Efficienza;
        \item Soddisfazione;
        \item Libertà da rischi;
        \item Contesto di copertura.
    \end{itemize}
\end{enumerate}
...
Gli standard di riferimento per la qualità del processo sono l'ISO/IEC 9001 e il modello CMMI (\textit{Capability Maturity Model Integration}). Questi standard forniscono le linee guida per la gestione della qualità nei processi di sviluppo, includendo la pianificazione, il controllo e il miglioramento continuo.

Secondo questo standard la qualità del processo si basa su diversi principi fondamentali:
\begin{itemize}
    \item \textbf{Responsabilità della leadership:} chi dirige ha il compito di delineare la politica della qualità, fissare i traguardi e assicurarsi che ogni componente del gruppo conosca i propri compiti.
    \item \textbf{Ottimizzazione delle risorse:} risulta prioritario dotare il team di strumenti idonei (quali IDE o sistemi di controllo versione come Git) e garantire ai collaboratori l'addestramento indispensabile.
    \item \textbf{Sviluppo dell'output:} il ciclo produttivo esige che la raccolta dei requisiti, il design e la codifica siano fasi monitorate e costantemente verificabili.
    \item \textbf{Valutazione e perfezionamento:} è vitale osservare con regolarità l'avanzamento dei lavori per scovare possibili margini di crescita e applicare rimedi tempestivi in caso di criticità.
\end{itemize}
