...
\begin{center}
    ...
    \begin{longtable}{|p{1.4cm}|p{1.8cm}|p{5cm}|p{2.4cm}|p{2.3cm}|p{2.3cm}|}
        ...
        \hline
        2.2.0 & 19/07/2026 & Aggiunti MPC-TSC, MPC-TPC e MPC-TEC.  & Eleonora Bellet & Alex Oloni & - \\
        \hline
...
Le misurazioni si riferiscono ai sette \glslink{sprint}{sprint} rendicontati:
...
\addplot[color=blue, mark=o, thick, dashed] coordinates {(S1,670) (S2,1235) (S3,1985) (S4,2835) (S5,3365) (S6,4345) (S7,5100)};
\addlegendentry{PV Cumulativo}
\addplot[color=teal, mark=x, thick] coordinates {(S1,670) (S2,1235) (S3,1985) (S4,2835) (S5,3365) (S6,4345) (S7,5100)};
...
\addplot[color=red!80!black, mark=square*, thick] coordinates {(S1,705) (S2,1330) (S3,2160) (S4,3135) (S5,3650) (S6,4605) (S7,5360)};
...
\noindent\textbf{Valutazione:} I costi effettivi sono positivi in tutti gli \glslink{sprint}{sprint} (\emph{soglia accettabile} raggiunta). Rispetto al PV si osserva un lieve sforamento iniziale, ridotto sensibilmente negli Sprint 5, 6 e 7grazie alle attività mirate di controllo sui costi operativi.
...
\addplot[color=orange, mark=violet, thick] coordinates {(S1,0.950) (S2,0.929) (S3,0.919) (S4,0.904) (S5,0.922) (S6,0.944) (S7,0.951)};
\addlegendentry{CPI}
\addplot[color=cyan!80!black, mark=triangle*, thick] coordinates {(S1,1.000) (S2,1.000) (S3,1.000) (S4,1.000) (S5,1.000) (S6,1.000) (S7,1.000)};
\addlegendentry{SPI}
\draw[red, thick, dashed] (axis cs:S1,0.9) -- (axis cs:S7,0.9);
...
\addplot[color=blue, mark=purple, thick] coordinates {(S1,13231) (S2,13544) (S3,13683) (S4,13906) (S5,13640) (S6,13328) (S7,13216)};
\addlegendentry{EAC}
\addplot[color=olive, mark=diamond*, thick] coordinates {(S1,12526) (S2,12214) (S3,11523) (S4,10771) (S5,9990) (S6,8723) (S7,7856)};
\addlegendentry{ETC}
\draw[green!60!black, ultra thick, dotted] (axis cs:S1,12575) -- (axis cs:S7,12575);
...
\addplot[color=teal, mark=*, thick] coordinates {(S3,100) (S4,96.9) (S5,100) (S6,87.8) (S7,100)};
\addlegendentry{RSI Rilevato}
\draw[red, thick, dashed] (axis cs:S1,70) -- (axis cs:S7,70);
...
\subsubsection{MPC-TSC -- Test Specification Coverage}

Misura la percentuale di casi di test specificati rispetto al numero totale di casi di test previsti.

\[
MPC\text{-}TSC = \frac{Test\ specificati}{Test\ previsti} \times 100
\]

L'obiettivo minimo stabilito dal gruppo è pari al 95\%.

\subsubsection{MPC-TPC -- Test Progress Coverage}

Misura la percentuale di casi di test implementati rispetto al numero totale di casi di test previsti.

\[
MPC\text{-}TPC = \frac{Test\ implementati}{Test\ previsti} \times 100
\]

L'obiettivo minimo stabilito dal gruppo è pari al 90\%.

\subsubsection{MPC-TEC -- Test Execution Coverage}

Misura la percentuale di casi di test eseguiti rispetto al numero totale di casi di test previsti.

\[
MPC\text{-}TEC = \frac{Test\ eseguiti}{Test\ previsti} \times 100
\]

L'obiettivo minimo stabilito dal gruppo è pari al 90\%.

\subsubsection{Interpretazione degli indicatori}

Gli indicatori relativi alla campagna di test consentono di monitorare lo stato di avanzamento delle attività di verifica. Valori inferiori alle soglie stabilite evidenziano la necessità di pianificare attività correttive nel corso dello \glslink{sprint}{Sprint} successivo, al fine di garantire il raggiungimento degli obiettivi di qualità definiti dal gruppo.
...
\begin{tabular}{|l|p{3.5cm}|p{3cm}|c|}
    ...
    \hline
\end{tabular}
\caption{Calcolo MPC-QMS aggiornato fino a S7}
\end{table}
...
\addplot[ybar stacked, fill=gray!8, pattern=crosshatch, pattern color=black!40, forget plot, bar width=16pt] coordinates {(S1,20) (S2,20) (S3,20) (S4,20) (S5,20) (S6,20) (S7,20)};

\addplot[ybar stacked, fill=none, pattern=dots, pattern color=black!40, forget plot, bar width=16pt] coordinates {(S1,80) (S2,80) (S3,80) (S4,80) (S5,80) (S6,80) (S7,80)};

\addplot[ybar, fill=blue!70!white, draw=none, bar width=8pt, forget plot] coordinates {(S1,100) (S2,0) (S3,0) (S4,0) (S5,0) (S6,0) (S7,0)};

\addplot[ybar, fill=green!60!black, draw=none, bar width=8pt, forget plot] coordinates {(S1,0) (S2,80) (S3,80) (S4,0) (S5,0) (S6,0) (S7,0)};

\addplot[ybar, fill=orange!80!white, draw=none, bar width=8pt, forget plot] coordinates {(S1,0) (S2,0) (S3,0) (S4,75) (S5,75) (S6,75) (S7,75)};
