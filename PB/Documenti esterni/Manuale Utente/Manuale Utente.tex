...
La generazione dei testi, delle copertine e l'analisi documentale usano \glslink{amazon-bedrock}{Amazon Bedrock}. \glslink{localstack}{LocalStack} non emula Bedrock: anche in ambiente locale servono credenziali \glslink{aws}{AWS} reali con accesso ai modelli abilitato nella console della region configurata.
...
\begin{itemize}
    \item \textbf{Barra laterale sinistra.} In alto il logo aLittleByte. Sotto, tre gruppi: \ui{Panoramica}, \ui{AI Assistant}, \ui{Co-Pilot \glslink{ai-co-pilot-per-consulenti-del-lavoro-cdl}{CdL}}. Ogni gruppo ha una voce principale e dei collegamenti alle sezioni della pagina (evidenziati mentre si scorre).
...
\begin{itemize}
    ...
    \item il blocco \ui{Documento finale}, visibile solo a generazione conclusa e se la \glslink{bozza-draft}{bozza} non è scartata: \ui{Apri anteprima} (nuova scheda) e \ui{Scarica PDF}. Ogni pagina del documento riporta il \glslink{marcatore-di-trasparenza}{marcatore di trasparenza} \textit{``Creato da AI Assistant''};
    \item la valutazione a stelle (paragrafo successivo);
    \item lo stato della \glslink{bozza-draft}{bozza} (\ui{\glslink{bozza-draft}{Bozza}}, \ui{Approvata} o \ui{Scartata}) e la dicitura \textit{``Creato da AI Assistant''};
