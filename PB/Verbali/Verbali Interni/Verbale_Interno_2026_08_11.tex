...
\section{Ordine del Giorno}
    \begin{itemize}
    \item \glslink{mvp-minimum-viable-product}{MVP}, specifica tecnica e monitoraggio
...
Si è concordato di minimizzare il numero di incontri con l'azienda, specialmente considerando il periodo estivo. La strategia prevede di mostrare il prodotto poco prima del completamento dell'\glslink{mvp-minimum-viable-product}{MVP} e ripetere un colloquio solo al termine, a meno che non emergano necessità urgenti di confronto.
...
\begin{table}[h]
    ...
    \hline
        \textit{A. Maule} & Stesura \glslink{verbale-interno}{Verbale Interno} 11/08/2026 & \href{https://github.com/aLittleByte-19/Documentazione/issues/164}{\#164}\\
    \hline
    \end{tabular}
