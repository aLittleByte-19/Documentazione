...
\section{Ordine del Giorno}
    \begin{itemize}
    \item Strategia repo \glslink{pb-product-baseline}{PB}/\glslink{mvp-minimum-viable-product}{MVP}: nuova repo e sostituzione occorrenze
    \item Aggiornamento azienda e richiesta riunione
    \item Definizione documentale: manuale utente e specifica tecnica in \glslink{bozza-draft}{bozza}
...
Si definiscono compiti di avvio: Leonardo crea la \glslink{repository}{repository} dell'\glslink{mvp-minimum-viable-product}{MVP}(\glslink{mvp-minimum-viable-product}{Minimum Viable Product}), Angelica si occuperà del refactoring dei nomi dei package,
...
Vinicius Y. Kaneda Fernandes si occuperà poi della sistemazione dei vari documenti che hanno avuto un riscontro avverso da parte dei professori nella correzione dell'\glslink{rtb-requirements-and-technology-baseline}{RTB}, che poi andranno implementati nella fase \glslink{pb-product-baseline}{PB}.
...
\item Modifica manuale della \glslink{bozza-draft}{bozza} generata
\item Generazione automatica/modifica manuale(/retry) dell’immagine di copertina contestuale al messaggio
\item Sistema di download come pdf per comunicazioni \glslink{ai-assistant-generativo-ai-assistant}{ai assistant}
\end{itemize}
Si è deciso di procedere per step graduali, Alex Oloni si dedicherà alla parte di implementazione dell'immagine di copertina, mentre il \glslink{rating}{rating} della risposta generata e modifica manuale delle bozze sarà implementato da Diego Belluz e Eleonora Bellet.
\newpage
\section{To-Do List}
\begin{table}[h]
    \centering
    ...
    \hline
        \textit {Leonardo Soligo} & Creazione nuova \glslink{repository}{repository} per sviluppo \glslink{mvp-minimum-viable-product}{MVP} & \href{https://github.com/aLittleByte-19/Documentazione/issues/148}{\#148}\\
    \hline
        \textit {Angelica Gastaldello} &  Refactoring per nuova \glslink{repository}{repository} & \href{https://github.com/aLittleByte-19/Documentazione/issues/149}{\#149}\\
    \hline
    ...
    \hline
        \textit{Eleonora Bellet e Diego Belluz} & Implementazione \glslink{rating}{rating} della risposta generata e modifica manuale delle bozze & \href{https://github.com/aLittleByte-19/Documentazione/issues/152}{\#152}\\
    \hline
        \textit{V.Y. Kaneda Fernandes} & Correzione documenti & 
        \href{https://github.com/aLittleByte-19/Documentazione/issues/153}{\#153}\\
    \hline
        \textit{Alex Oloni} & Stesura \glslink{verbale-interno}{Verbale Interno} 14/07/2026 & \href{https://github.com/aLittleByte-19/Documentazione/issues/154}{\#154}\\
    \hline
    \end{tabular}
