...
\section{Ordine del Giorno}
    \begin{itemize}
    \item Presentazione dell'\glslink{mvp-minimum-viable-product}{MVP (Minimum Viable Product)} del progetto e dimostrazione live.
...
\textbf{Leonardo Soligo} ha guidato la presentazione dell'\glslink{mvp-minimum-viable-product}{MVP} rivolta ai referenti aziendali. Tramite la condivisione dello schermo, è stato mostrato l'applicativo in funzione. È stato confermato che lo stack tecnologico utilizzato è rimasto invariato rispetto alle scelte architetturali precedenti. Sono stati mostrati quindi:
\begin{itemize}
    \item Overview iniziale: panoramica su documenti da verificare, bozze da valutare e dati medi.
    \item Modulo \glslink{ai-assistant-generativo-ai-assistant}{AI Assistant}: generazione automatica di testo, copertina e PDF finale, sistema di \glslink{rating}{rating}, storico documenti con filtri e metriche.
...
I referenti aziendali hanno richiesto chiarimenti specifici sul metodo di calcolo della percentuale di affidabilità/\glslink{confidenza-confidence-score}{confidenza} mostrata dal sistema. Leonardo Soligo ha quindi fornito le relative spiegazioni, illustrando anche visivamente le modalità con cui tali percentuali vengono determinate.

\subsection{Valutazione e approvazione finale da parte dell'azienda referente.}
L'azienda si è espressa in modo \textbf{positivo} riguardo al lavoro svolto e alle funzionalità presentate. Ha complimentato il team per i risultati raggiunti e ha \textbf{approvato} ufficialmente l'\glslink{mvp-minimum-viable-product}{MVP} presentato.
\section{To-Do List}
\begin{table}[h]
    \centering
