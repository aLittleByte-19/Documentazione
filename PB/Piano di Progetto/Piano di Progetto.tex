...
\begin{center}
    ...
    \begin{tcolorbox}[
        ...
        \begin{tabularx}{\linewidth}{>{\bfseries}p{3.5cm} X}
            ...
            Versione & 2.5.0 \\
            Redattori   & A. Maule, A. Oloni, E. Bellet, V. Y. K. Fernandes \\
...
\begin{itemize}
    \item \textbf{\glslink{glossario}{Glossario} v.2.0.0}
    \begin{itemize}
        \item \url{https://alittlebyte-19.github.io/Documentazione/RTB/Glossario/Glossario.pdf}
        \item \textit{Data ultimo accesso: 13/06/2026}
    \end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Attività Pianificate (\glslink{sprint}{Sprint} Backlog):} Una tabella di dettaglio che elenca i task assegnati ai vari ruoli, confrontando le ore preventivate con quelle effettivamente consumate a \glslink{consuntivo}{consuntivo}. Ogni attività è accompagnata dal relativo stato di avanzamento, indicato con le diciture ``\textit{Completata}'' o ``\textit{In corso}''.
    \begin{quote}
...
\subsubsection{Periodi}
Superata la fase \glslink{rtb-requirements-and-technology-baseline}{RTB}, il team ha avviato la fase \glslink{pb-product-baseline}{PB}, riprendendo la suddivisione del lavoro in \glslink{sprint}{Sprint} secondo lo stesso schema adottato in precedenza, in continuità di numerazione con i periodi già rendicontati. La fase \glslink{pb-product-baseline}{PB} è, ad oggi, suddivisa in 3 iterazioni (\glslink{sprint}{Sprint}), fino al decimo \glslink{sprint}{Sprint}.
...
Il decimo periodo è stato dedicato prevalentemente al consolidamento della documentazione di progetto e al proseguimento dello sviluppo dell'\glslink{mvp-minimum-viable-product}{MVP}. Sul fronte documentale sono stati aggiornati il \glslink{piano-di-progetto}{Piano di Progetto} e il \glslink{piano-di-qualifica}{Piano di Qualifica} con il rendiconto del periodo, le \glslink{norme-di-progetto}{Norme di Progetto} e le specifiche tecniche, oltre alla stesura del consueto \glslink{verbale-interno}{verbale interno}. In parallelo l'\glslink{analista}{Analista} ha svolto un controllo di verifica sull'\glslink{analisi-dei-requisiti-adr}{Analisi dei Requisiti}, mentre il \glslink{programmatore}{Programmatore} ha proseguito lo sviluppo dell'\glslink{mvp-minimum-viable-product}{MVP} e il \glslink{verificatore}{Verificatore} ha effettuato la verifica di codice e documenti prodotti nel periodo. Non sono stati riscontrati nuovi rischi durante questo \glslink{sprint}{Sprint}.
...
\subsubsection{Rendiconto ore rimanenti al termine del primo sprint}
...
\subsubsection{Rendiconto ore rimanenti al termine del secondo sprint}
\begin{table}[htbp]
\centering
\renewcommand{\arraystretch}{1.5} 
\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
...
\subsubsection{Rendiconto ore rimanenti al termine del terzo sprint}
\begin{table}[htbp]
\centering
\renewcommand{\arraystretch}{1.5} 
\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
...
\subsubsection{Aggiornamento del Preventivo a Finire - Sprint 4}
...
\subsubsection{Rendiconto ore rimanenti al termine del quarto sprint}
...
\newpage
\subsection {Quinto Periodo: Sprint 25/05/2026 - 07/06/2026}
...
\subsubsection{Aggiornamento del Preventivo a Finire - Sprint 5}
...
\subsubsection{Rendiconto ore rimanenti al termine del quinto sprint}
\begin{table}[htbp]
\centering
\renewcommand{\arraystretch}{1.5} 
\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
...
\newpage
\subsection {Sesto Periodo: Sprint 08/06/2026 - 21/06/2026}

\label{sec:pec_sestoperiodo}
...
\subsubsection{Aggiornamento del Preventivo a Finire - Sprint 6}
...
\subsubsection{Rendiconto ore rimanenti al termine del sesto sprint}
\begin{table}[htbp]
\centering
\renewcommand{\arraystretch}{1.5} 
\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
...
\newpage
\subsection {Settimo Periodo: Sprint 22/06/2026 - 05/07/2026}

\label{sec:pec_settimoperiodo}
...
\subsubsection{Aggiornamento del Preventivo a Finire - Sprint 7}
...
\subsubsection{Rendiconto ore rimanenti al termine del settimo sprint}
\begin{table}[htbp]
\centering
\renewcommand{\arraystretch}{1.5}
\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
...
\newpage
\subsection {Ottavo Periodo: Sprint 06/07/2026 - 19/07/2026}

\label{sec:pec_ottavoperiodo}
...
\subsubsection{Aggiornamento del Preventivo a Finire - Sprint 8}
...
\subsubsection{Rendiconto ore rimanenti al termine dell'ottavo sprint}
\begin{table}[htbp]
\centering
\renewcommand{\arraystretch}{1.5}
\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
...
\newpage
\subsection {Nono Periodo: Sprint 20/07/2026 - 02/08/2026}

\label{sec:pec_nonoperiodo}
...
\subsubsection{Aggiornamento del Preventivo a Finire - Sprint 9}
...
\subsubsection{Rendiconto ore rimanenti al termine del nono sprint}
\begin{table}[htbp]
\centering
\renewcommand{\arraystretch}{1.5}
\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
...
\newpage
\subsection {Decimo Periodo: Sprint 03/08/2026 - 16/08/2026}

\label{sec:pec_decimoperiodo}
...
\subsubsection{Aggiornamento del Preventivo a Finire - Sprint 10}
...
\subsubsection{Rendiconto ore rimanenti al termine del decimo sprint}
\begin{table}[htbp]
\centering
\renewcommand{\arraystretch}{1.5}
\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
