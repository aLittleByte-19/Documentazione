...
\subsubsection{Periodi}
Superata la fase \glslink{rtb-requirements-and-technology-baseline}{RTB}, il team ha avviato la fase \glslink{pb-product-baseline}{PB}, riprendendo la suddivisione del lavoro in \glslink{sprint}{Sprint} secondo lo stesso schema adottato in precedenza, in continuità di numerazione con i periodi già rendicontati. La fase \glslink{pb-product-baseline}{PB} è, ad oggi, suddivisa in 2 iterazioni (\glslink{sprint}{Sprint}), fino al nono \glslink{sprint}{Sprint}.
