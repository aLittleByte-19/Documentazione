...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{|p{1.4cm}|p{1.8cm}|X|p{2.4cm}|p{2.3cm}|p{2.3cm}|}
        ...
        \hline
        0.0.7 & 12/03/2026 & Iniziato C5 & Angelica Gastaldello & - & - \\
        \hline
        0.0.6 & 11/03/2026 & Stesura analisi capitolato C6 & Diego Belluz & - & - \\
        \hline
        0.0.5 & 10/03/2026 & Stesura analisi capitolato C4 & Diego Belluz & - & - \\
        \hline
...
Nonostante tali criticità, il gruppo ha ritenuto che C5 rappresentasse la scelta migliore. Il capitolato è stato valutato come quello più allineato agli obiettivi formativi e progettuali del team, poiché unisce interesse tecnologico, struttura chiara, rilevanza industriale e possibilità concreta di realizzare un prodotto di qualità entro i vincoli temporali del corso.
