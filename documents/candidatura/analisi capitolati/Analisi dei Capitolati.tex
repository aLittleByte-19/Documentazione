...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{|p{1.4cm}|p{1.8cm}|X|p{2.4cm}|p{2.3cm}|p{2.3cm}|}
        ...
        \hline
        0.0.5 & 11/03/2026 & Stesura analisi capitolati C4 e C6 & Diego Belluz & - & - \\
        \hline
...
\subsubsection{Requisiti funzionali principali e obbligatori}
...
Le funzionalità opzionali che emergono sono:
\begin{itemize}
    \item integrazione con strumenti indossabili come smartwatch per inviare notifiche di allarme;
    \item modalità di ``check-in'' periodico, che invia alert se non viene effettuato;
    \item funzionalità di ``fuga rapida'', che attiva allarmi e registrazioni audio-video;
    \item rilevamento ambientale, che analizza suoni e rumori associati a situazioni di pericolo;
    \item gamification dei supporti educativi con punti e livelli;
    \item supporto multilingue avanzato, che include anche lingue meno diffuse e dialetti;
    \item report anonimo ad enti di ricerca per studi sulla violenza di genere;
    \item integrazione con la legislazione vigente per fornire informazioni sulle leggi relative alla violenza di genere;
    \item accessibilità per persone con disabilità visive, uditive o motorie.
\end{itemize}
...
Zucchetti S.p.A. propone di sfruttare la potenza degli LLM tramite:
\begin{itemize}
