...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{|l|l|X|p{2cm}|p{2cm}|p{2cm}|}
        \hline
        \rowcolor{gray!20}
        \textbf{Ver.} & \textbf{Data} & \textbf{Descrizione} & \textbf{Redattore} & \textbf{Verificatore} & \textbf{Approvatore} \\
        \hline 
        1.2 & 2026-03-11 & Stesura sezione 3 (Preventivo costi) & Angela Maule & - & - \\
        \hline 
        1.1 & 2026-03-10 & Stesura sezione 2 (Impegno orario e Ruoli) & A. Maule, E. Bellet & - & - \\
        \hline
        1.0 & 2026-03-09 & Struttura del documento e Introduzione & Eleonora Bellet & - & - \\
        \hline 
    \end{tabularx}
    }
\end{center}
...
Con il seguente documento, il gruppo aLittleByte (Gruppo 19) di Ingegneria del Software dichiara l'impegno orario preventivato per l'implementazione del capitolato C5 - Nexum, proposto da Eggon, confermando la propria candidatura per la sua realizzazione.
...
Il preventivo orario complessivo di 630 ore è stato suddiviso assegnando a ciascun membro un impegno di 90 ore produttive. Per assicurare una crescita professionale completa, il gruppo ha pianificato una rotazione dei ruoli ogni due settimane ( DA SENTIRE AZIENDA per allinearsi in modo naturale agli sprint concordati con l'azienda proponente.)
